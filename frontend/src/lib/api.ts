...
export const productosApi = {
  getAll: (params?: Record<string, any>) => api.get("/productos", { params }),
  ...
  importarExcel: (file: File) => {
    ...
    return api.post("/productos/importar/excel", formData, { headers: { "Content-Type": "multipart/form-data" } });
  },
...
export const ventasApi = {
  ...
  cancelar: (id: number, motivo?: string) => api.patch(`/ventas/${id}/cancelar`, { motivo }),
...
export const gastosApi = {
  ...
  getResumenMensual: (año?: number) => api.get("/gastos/resumen-mensual", { params: { año } }),
};

export const reportesApi = {
  getGeneral: (año?: number) => api.get("/reportes/general", { params: { año } }),
  exportarInventario: () => api.get("/reportes/exportar/inventario", { responseType: "blob" }),
